...
@section('content')
    <div class="container mx-auto py-2 w-full bg-gray-700 rounded-lg mt-3">
        ...
        <div class="display flex w-full">
            <div class="ml-3 drop-shadow-xl bg-gray-500 rounded-md" style="width: 350px; !important">
            ...
            <div class="drop-shadow-lg bg-gray-500 px-2 py-2 rounded-md" style="margin-top: 36px; margin-left: 30px; margin-right: 10px; width: 90%;">
                <div class="text-right mt-3 mb-3">
                    <form action="  " method="post">
                        @csrf
                        <input class="border border-black text-xl px-6 py-2 rounded-md w-80" type="text" name="search" placeholder="Pesquise o nome do usuário" value="{{old('pesquisa')}}">
