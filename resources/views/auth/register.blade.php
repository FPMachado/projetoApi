        ...
        <div class="w-96 p-6 shadow-lg bg-gray-500 rounded-md">
            ...
            <form action="{{route('teste')}}" method="POST">
                ...
                <div class="mt-3">
                    ...
                    <input type="password" name="confirmSenha" class="border w-full text-base px-2 py-1 rounded-md focus:outline-none focus:ring-0 focus:border-yellow-400" placeholder="Insira novamente sua senha"/>
                </div>
