    ...
    <div class="flex container mx-auto p-2 w-full bg-gray-700 rounded-lg mt-3">
            ...
            <div class="ml-3" style="width: 350px !important;">
                ...
                <div>
                    ...
                    <input
                        ...
                        type="date" name="assisted_in" id="assisted_in" value="{{ $personal_data->assisted_in }}">
        ...
        <div style="width: 490px !important;">
            ...
            <textarea class="border resize-y text-base px-2 py-1 rounded-md focus:outline-none focus:ring-0 focus:border-yellow-400"
                name="synopsis" id="synopsis" cols="61" rows="5" disabled>{{ $data_movie->synopsis }}</textarea>
            <label for="note" class="block font-semibold text-yellow-500">Observações sobre o filme</label>
            <textarea class="border resize-y text-base px-2 py-1 rounded-md focus:outline-none focus:ring-0 focus:border-yellow-400"
                name="observation" id="observation" cols="61" rows="5">{{ $personal_data->observation }} </textarea>
            <div class="flex">
